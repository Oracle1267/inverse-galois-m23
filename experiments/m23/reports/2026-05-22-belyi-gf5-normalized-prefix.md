# M23 Belyi GF(5) Normalized Prefix Search
...
| statistic | value |
| --- | --- |
| enumerated_left_factor_triples | 88 |
| tested_left_factor_triples | 50 |
| skipped_left_factor_triples | 0 |
| tested_lambda_values | 200 |
