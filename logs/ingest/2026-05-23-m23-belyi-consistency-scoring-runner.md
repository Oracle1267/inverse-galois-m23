...
- Added cheap linear symbolic conflict detection for incompatible forced values of the same unresolved coefficient.
- Added full linear-system rank checking for multivariate linear inconsistencies.
