...
Currently, Working on [AKBP: Agent Knowledge Base Protocol](https://github.com/rohitg00/akbp) based on my findings, a protocol for creating, updating, retrieving, and sharing durable knowledge across AI agents.
